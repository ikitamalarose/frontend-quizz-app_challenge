...
function getFragmentId() {
    ...
    function getFragmentId() {
        ...
        // Vérifier si l'URL contient un ".html", sinon utiliser le dernier segment du chemin
        if (currentUrl.includes(".html")) {
            ...
            filename = pathSegments[pathSegments.length - 1] || "index"; // "index" est utilisé si le chemin est vide
        }
