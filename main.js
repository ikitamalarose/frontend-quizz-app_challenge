...
function getFragmentId() {
    ...
    function getFragmentId() {
        ...
        // Vérifier si l'URL contient un ".html", sinon on utilise le dernier segment du chemin
        if (currentUrl.includes(".html")) {
            ...
            // Utiliser le dernier segment du chemin si l'URL ne contient pas de .html
            const pathSegments = window.location.pathname.split("/");
            return pathSegments[pathSegments.length - 1] || "index"; // "index" est utilisé si le chemin est vide
        }
    }
